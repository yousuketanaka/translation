...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" class="form-control" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p>',
		...
		'submit_button'        => '<input name="%1$s" type="submit" id="%2$s" class="%3$s form-control btn-primary" value="%4$s" />',
